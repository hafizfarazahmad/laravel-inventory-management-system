    ...
    <div class="col-md-10 offset-1">
        <div class="card">
            <div class="card-header">
                <a href="{{ route('product.create') }}" class="btn btn-primary btn-sm " style="border-radius: 0px !important"> <i class="bi bi-plus-circle"></i> Add Product</a>
            </div>
            <div class="card-body">
                                    ...
                                    <td>
                                        @if ($product->image)
                                            <img class="img-thumbnail"
                                                src="{{ asset('uploads/products/' . $product->image) }}" height="50"
                                                width="50">
                                        @else
